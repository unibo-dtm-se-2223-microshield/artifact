...
from dashield.ui.app import build_gauge_figure, build_scatter_figure, create_dashboard_app
...
def test_figure_builders() -> None:
    """Verify pure figure builder functions output valid Plotly structures."""
    gauge = build_gauge_figure(0.08, 0.05)
